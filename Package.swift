...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-NStationDownload/raw/main/NStationOfferwall1.8.4.xcframework.zip",
            checksum: "966ff86415e2a05dbbcd7701fd578e4766b92dd2cfc9177cf06a17f190651580"
        ),
        .binaryTarget(
            name: "Kingfisher",
