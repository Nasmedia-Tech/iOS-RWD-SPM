...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-NStationDownload/raw/main/NStationOfferwall1.9.1.xcframework.zip",
            checksum: "3d7ab89710add97e26839422248806823664ea5def47d1b0c6fa369ffa00809d"
        ),
        .binaryTarget(
            name: "Kingfisher",
