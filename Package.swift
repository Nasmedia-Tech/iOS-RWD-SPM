...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-NStationDownload/raw/main/NStationOfferwall1.8.5-beta.4.xcframework.zip",
            checksum: "a3a811b02d4268e907f09ef96c724edc121c2040301245f2102113a358c9c892"
        ),
        .binaryTarget(
            name: "Kingfisher",
