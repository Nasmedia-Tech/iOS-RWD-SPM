...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-NStationDownload/raw/main/NStationOfferwall1.8.3-beta.2.xcframework.zip",
            checksum: "59aa2239976f6bae621dc63c3887c3d22611df065ece77da70a148aa6680024d"
        ),
        .binaryTarget(
            name: "Kingfisher",
