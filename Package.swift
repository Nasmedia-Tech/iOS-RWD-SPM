...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-NStationDownload/raw/main/NStationOfferwall1.8.5-beta.xcframework.zip",
            checksum: "42906903b1e6c4f36af74677cb90230830ae245901a06803d8ddd5b7ec86390f"
        ),
        .binaryTarget(
            name: "Kingfisher",
