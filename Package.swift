...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-NStationDownload/raw/main/NStationOfferwall1.9.0.xcframework.zip",
            checksum: "ff206bf1de48d0e563f226554f93ac459ace2cab4e28cd9efddee7bc41be6fc1"
        ),
        .binaryTarget(
            name: "Kingfisher",
