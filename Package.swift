...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-NStationDownload/raw/main/NStationOfferwall1.8.3.xcframework.zip",
            checksum: "75593039e798647c5aa104e0eb43b7e6359a649393bd5f4806062e24542890af"
        ),
        .binaryTarget(
            name: "Kingfisher",
