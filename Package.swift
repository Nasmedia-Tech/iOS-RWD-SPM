...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-NStationDownload/releases/download/v1.9.28/NStationOfferwall1.9.28.xcframework.zip",
            checksum: "aa4b5a585a76cafd2ae1a1f8c0ce076468ff3df629a5df50a148e26a3ce91feb"
        ),
        .target(
            name: "iOS_RWD_SPM",
            dependencies: [
