...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-NStationDownload/releases/download/v1.9.25/NStationOfferwall1.9.25.xcframework.zip",
            checksum: "65385d378220dda9b29d397c3f706baefe34219f67940a67bae6ada5adaa3d63"
        ),
        .target(
            name: "iOS_RWD_SPM",
            dependencies: [
