...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-NStationDownload/releases/download/v1.9.4/NStationOfferwall1.9.4.xcframework.zip",
            checksum: "0371d5d4f3905c081c030a479c470a1867b7d90161593478b03a1aa11c076b34"
        ),
        .binaryTarget(
            name: "Kingfisher",
