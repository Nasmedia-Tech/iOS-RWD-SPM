...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-NStationDownload/raw/main/NStationOfferwall1.8.5-beta.5.xcframework.zip",
            checksum: "ac5bebca105192756b6740bdf22000670c6a22a4368c29f52549d593ba0ba855"
        ),
        .binaryTarget(
            name: "Kingfisher",
