...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-NStationDownload/releases/download/v1.9.22/NStationOfferwall1.9.22.xcframework.zip",
            checksum: "2d475114709f06e820cc90c9e118efa64af0e64580acbb749bc7b795da4da844"
        ),
        .target(
            name: "iOS_RWD_SPM",
            dependencies: [
