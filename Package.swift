...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-NStationDownload/releases/download/v1.9.8/NStationOfferwall1.9.8.xcframework.zip",
            checksum: "592f18ec0d6ae2e2301992fb9991279ed7e2b31a66e55d77474b641d8b9cf403"
        ),
        .binaryTarget(
            name: "Kingfisher",
