...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-NStationDownload/releases/download/v1.9.16/NStationOfferwall1.9.16.xcframework.zip",
            checksum: "0ca30a7ec3537abced2916b9480933e8be924a0d9deaf2b1891d93d1c5bfb97a"
        ),
        .target(
            name: "iOS_RWD_SPM",
            dependencies: [
